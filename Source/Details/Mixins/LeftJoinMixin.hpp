...
namespace CppLinq::Details::Mixins
{
    ...
    struct LeftJoinMixin
    {
        ...
        auto LeftJoin(const Query<TOtherEnumerator>& otherQuery, const TLeftKeySelector leftKeySelector, const TRightKeySelector otherSelector, const TResultSelector resultSelector, const TComparer comparer) const -> Query<Enumerators::LeftJoinEnumerator<EnumeratorType, TOtherEnumerator, TLeftKeySelector, TRightKeySelector, TResultSelector, TComparer>>;
    };
}