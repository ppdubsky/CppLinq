...
namespace CppLinq::Details::Enumerators
{
    ...
    struct UnionEnumerator final : EnumeratorWrapper<TFirstEnumerator>
    {
        ...
        UnionEnumerator(const TFirstEnumerator firstEnumerator, const TSecondEnumerator secondEnumerator, const TKeySelector keySelector, const TKeyComparer keyComparer);
