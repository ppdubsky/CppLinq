...
{
    TEST(Zip_two_sequences_when_second_one_is_longer, Returns_expected_sequence)
    {
        // Arrange.
    ...
    TEST(Zip_two_sequences_when_second_one_is_longer, Returns_the_same_result_on_every_call)
    {
        // Arrange.
        const double source1[]{ 1.1, 2.2, 3.3 };
        const int source2[]{ 'a', 'b', 'c', 'd', 'e' };
